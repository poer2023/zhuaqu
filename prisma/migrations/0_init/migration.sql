...
-- CreateIndex
CREATE INDEX "content_items_workspaceId_poolId_rewriteStatus_idx" ON "content_items"("workspaceId", "poolId", "rewriteStatus");

-- CreateIndex
CREATE INDEX "content_items_workspaceId_publishStatus_idx" ON "content_items"("workspaceId", "publishStatus");

-- CreateIndex
CREATE INDEX "content_items_poolId_captureStatus_idx" ON "content_items"("poolId", "captureStatus");

-- CreateIndex
CREATE INDEX "content_items_workspaceId_poolId_publishStatus_idx" ON "content_items"("workspaceId", "poolId", "publishStatus");

-- CreateIndex
CREATE INDEX "content_items_workspaceId_createdAt_idx" ON "content_items"("workspaceId", "createdAt");
